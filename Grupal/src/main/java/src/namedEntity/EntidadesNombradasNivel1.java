...
class organizacion extends EntidadNombrada {
  ...
  organizacion(
      String name, String category, int frequency, String nc, int NroMiembros, String tipoOrg) {
    super(name, category, frequency, nc);
...
class producto extends EntidadNombrada {
  ...
  producto(
      String name, String category, int frequency, String nc, String Comercial, String Productor) {
    super(name, category, frequency, nc);
