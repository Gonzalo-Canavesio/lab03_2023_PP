    ...
    public EntidadNombrada createEntity(String namedEntity){
		...
		if(data == null){
			...
			if(category == "Apellido" && tema == "Futbol"){
				ne = new apellidoFutbol(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"));
				ne.setTema(tema);
			} else if(category == "Apellido" && tema == "Cine"){
				ne = new apellidoCine(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"));
				ne.setTema(tema);
			} else if(category == "Apellido" && tema == "Nacional"){
				ne = new apellidoNacional(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"));
				ne.setTema(tema);
			} else if(category == "Nombre" && tema == "Futbol"){
				ne = new nombreFutbol(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"), (String) data.get("formasAlt"));
				ne.setTema(tema);
			} else if(category == "Nombre" && tema == "Cine") {
				ne = new nombreCine(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"), (String) data.get("formasAlt"));
				ne.setTema(tema);
			} else if(category == "Nombre" && tema == "Cine") {
				...
				ne = new nombre(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")), (String) data.get("origen"), (String) data.get("formasAlt"));
				ne.setTema(tema);
				...
				ne = new OtroLugar(namedEntity, category, 1, nc, (String) data.get("comentario"));
				ne.setTema(tema);
			} else if(category == "Persona"){
				ne = new persona(namedEntity, category, 1, nc, Integer.parseInt((String) data.get("id")));
				ne.setTema(tema);
				...
				ne = new otro(namedEntity, category, 1, nc, (String) data.get("comentario"));
				ne.setTema(tema);
			} else {
				ne = new EntidadNombrada(namedEntity, category, 1, nc);
				ne.setTema(tema);
			}
		}
		return ne;
